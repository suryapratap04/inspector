...
export function createDatabaseRoutes(databaseManager: DatabaseManager): Router {
  ...
  // Get all metadata
  router.get('/metadata', asyncHandler(async (req: any, res: any) => {
  ...
  router.get('/metadata/:key', asyncHandler(async (req: any, res: any) => {
  ...
  // Set metadata value
  router.post('/metadata/:key', asyncHandler(async (req: any, res: any) => {
  ...
  // Delete metadata key
  router.delete('/metadata/:key', asyncHandler(async (req: any, res: any) => {
