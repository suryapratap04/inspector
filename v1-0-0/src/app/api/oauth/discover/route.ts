...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      authorization_server_metadata: discoveryResult.authorization_server?.authorization_server_metadata,
      protected_resource_metadata: discoveryResult.protected_resource?.protected_resource_metadata,
